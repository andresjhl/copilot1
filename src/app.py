...
activities = {
    ...
    "Debate Team": {
        "description": "Practice debate formats, research topics, and compete in tournaments",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["amelia@mergington.edu", "elijah@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions with hands-on events and team challenges",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["zachary@mergington.edu", "grace@mergington.edu"]
    }
}
